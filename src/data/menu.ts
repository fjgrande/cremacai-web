	...
	ca: [
		{
			...
			items: [
				{ name: "Amazalfi", origin: "De l'Amazones a la Costa Amalfitana", description: "Sorbet de Llimona · Cacauet · Quinoa inflada · Llet condensada", prices: [{ size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
				{ name: "Brasicilia", origin: "Del cor del Brasil a Sicília", description: "Gelato de Pistatxo · Pistatxo molt · Anacards · Salsa de Pistatxo", prices: [{ size: "M", amount: "11,90 €" }, { size: "L", amount: "13,90 €" }] },
				{ name: "Bahiatorino", origin: "De Bahia a Torí", description: "Gelato de Xocolata · Oreo · Nibs de cacau · Nutella", prices: [{ size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
				{ name: "Riocaracas", origin: "De Rio de Janeiro a Caracas", description: "Sorbet de Mango · Coco laminat · Quinoa inflada · Salsa de Mango o Maracujà", prices: [{ size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
				{ name: "Huelvaçu", origin: "De Huelva a Foz do Iguaçu", description: "Gelato de Maduixa · Coco laminat · Xia · Llet condensada", prices: [{ size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
				{ name: "Copa del Chef", origin: "Destinació sorpresa", description: "Recepta de temporada", prices: [{ size: "M", amount: "11,90 €" }, { size: "L", amount: "12,90 €" }] },
			],
		},
		{
			id: "bowlacai",
		...
		},
		{
			...
			items: [
				{ name: "Creaçaí", prices: [{ size: "S", amount: "10,90 €" }, { size: "M", amount: "12,90 €" }, { size: "L", amount: "14,90 €" }] },
			],
			toppingGroups: [
	...
	es: [
		{
			...
			items: [
				...
				{ name: "Brasicilia", origin: "Del corazón de Brasil a Sicilia", description: "Gelato de Pistacho · Pistacho molido · Anacardos · Salsa de Pistacho", prices: [{ size: "M", amount: "11,90 €" }, { size: "L", amount: "13,90 €" }] },
		...
		},
		{
			...
			items: [
				...
				{ name: "Energía", description: "Plátano · Anacardos · Quinoa · Cacahuete", prices: [{ size: "S", amount: "8,90 €" }, { size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
				{ name: "Calma", description: "Fresa · Arándanos · Chía · Salsa de fresa", prices: [{ size: "S", amount: "8,90 €" }, { size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
				{ name: "Frescura", description: "Kiwi · Plátano · Quinoa · Mango o maracuyá", prices: [{ size: "S", amount: "8,90 €" }, { size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
		...
		},
		{
			...
			toppingGroups: [
				{ label: "Clásicos · +1,00 €", items: ["Frutas", "Coco", "Chía", "Quinoa", "Cacahuete", "Anacardos", "Oreo", "Leche en polvo"] },
		...
		},
		{
			...
			items: [
				...
				{ name: "Funk", description: "Leche · Gelato de Chocolate · Salsa de Chocolate", prices: [{ amount: "7,90 €" }] },
	...
	en: [
		{
			...
			items: [
				...
				{ name: "Brasicilia", origin: "From the heart of Brazil to Sicily", description: "Pistachio Gelato · Ground Pistachio · Cashews · Pistachio Sauce", prices: [{ size: "M", amount: "11,90 €" }, { size: "L", amount: "13,90 €" }] },
				...
				{ name: "Riocaracas", origin: "From Rio de Janeiro to Caracas", description: "Mango Sorbet · Coconut Flakes · Puffed Quinoa · Mango or Passion Fruit Sauce", prices: [{ size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
				{ name: "Huelvaçu", origin: "From Huelva to Foz do Iguaçu", description: "Strawberry Gelato · Coconut Flakes · Chia · Condensed Milk", prices: [{ size: "M", amount: "10,90 €" }, { size: "L", amount: "12,90 €" }] },
		...
		},
		{
			...
			toppingGroups: [
				...
				{ label: "Premium · +1,50 €", items: ["Whey Protein", "Plant Protein", "Pistachio", "Cacao Nibs", "Pistachio Cream", "Peanut", "Nutella", "Dulce de Leche Cream"] },
			],
		},
		{
			id: "shakes",
			...
			items: [
				...
				{ name: "Chef's Shake", description: "Chef's Flavours", prices: [{ amount: "8,90 €" }] },
			],
		},
		{
			id: "gelato",
...
export const taglinesByLocale: Record<Locale, { tagline: string; instagram: string }> = {
	ca: { tagline: "La vida és més bona quan es barreja.", instagram: "Segueix-nos a Instagram!" },
	es: { tagline: "La vida sabe mejor cuando se mezcla.", instagram: "¡Síguenos en Instagram!" },
	en: { tagline: "Life is better when it's blended.", instagram: "Follow us on Instagram!" },
};

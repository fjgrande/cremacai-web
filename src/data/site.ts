...
export const location: LocationInfo = {
  ...
  hours: "Lunes a viernes, 10:30 – 23:00 // Sábado y Domingo, 12:00 - 23:00",
  mapEmbedSrc:
...
export const storyBlocks: StoryBlock[] = [
  {
    ...
    image: "/assets/helado-cremacai.jpg",
    imageAlt:
      "Dos conos de gelato artesanal cremaçai, sabores distintos, sobre el mosaico de la marca",
  },
  {
  ...
  },
  {
    ...
    imageAlt:
      "Vistas de Barcelona al atardecer, con el Park Güell en primer plano",
  },
  {
    ...
    image: "/assets/bowl-cremacai.jpg",
    imageAlt:
      "Mano sosteniendo un Bowlaçaí cremaçai con fresas, arándanos y chía",
    reverse: true,
  },
];
...
export const featuredRecipe: FeaturedRecipe = {
  ...
  imageAlt:
    "Paltaçaí, Copa del Chef: açaí con bola de sorbete de aguacate, cacahuete triturado y quinoa",
